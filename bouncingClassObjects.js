...
function setup() {
  ...
  for(let bubblesBlown=0; bubblesBlown<50;bubblesBlown++){   
    ...
    bubblez[bubblesBlown]=new Bubble(thisX, thisY, thisR,thisFloatSpeed,thisFloatSpeedY);
...
function draw() {
  ...
  let bubble3 = new Bubble(80,350,50);
  let bubble4 = new Bubble(230,250,65);
  let bubble5 = new Bubble(150,230,35);*/
...
class Bubble {
  ...
  move() {
    ...
    if (this.x > width-this.r || this.x < 0+this.r) {
      this.floatSpeed = this.floatSpeed * -1;
    }
     else if(this.y>height-this.r || this.y<0+this.r){
      this.floatSpeedY=this.floatSpeedY*-1
    }
  }
}
